        ...
        <div className="min-h-screen flex items-center justify-center bg-background px-4">
            <div className="w-full max-w-md bg-secondary/50 shadow-md rounded-lg p-6">
                ...
                <div className="text-center mb-4">
                    <h1 className="text-xl font-semibold">Sign up with your work email</h1>
                    <p className="text-sm text-gray-500 mt-1">Use your work email to sign up to your team workspace.</p>
                </div>
